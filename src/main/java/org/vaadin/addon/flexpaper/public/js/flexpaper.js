...
window.FlexPaperViewerEmbedding = window.$f = function(id, args) {
    ...
    _baseUrl            = (config.baseUrl!=null?config.baseUrl:"vaadin-flexpaper/VAADIN/widgetsets/org.vaadin.addon.flexpaper.VaadinFlexpaperWidgetset/");
    ...
    window[instance] = flashembed(id, {
        src						    : _baseUrl + "swf/FlexPaperViewer.swf",
        version					    : [10, 0],
        expressInstall			    : _baseUrl + "swf/expressinstall.swf",
        wmode					    : _WMode
    },{
        ElementId               : id,
        SwfFile  				: _SWFFile,
